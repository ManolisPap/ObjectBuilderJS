...
describe('Object Builder, Arrays with multiple elements', () => {
  ...
  test('Test E.2', () => {
    ...
    const result = objectBuilder('user.company.addresses[1].address', tmp, 'address2');
    expect(result).toStrictEqual(obj);
  });
  ...
  test('Test E.3', () => {
    ...
    const result = objectBuilder('user.company.addresses[0].telephones[1].number', tmp, 345);
    expect(result).toStrictEqual(obj);
  });
  ...
  test('Test E.4', () => {
    ...
    const result = objectBuilder('user.company.addresses[0].telephones[0].numbers[1].2', tmp, 345);
    expect(result).toStrictEqual(obj);
  });
  ...
  test('Test E.5', () => {
    ...
    const tmp = objectBuilder('user.company.addresses[0].telephones[0].numbers[0].1', {}, 123);
    const result = objectBuilder('user.company.addresses[0].telephones[1].numbers[0].1', tmp, 345);
    expect(result).toStrictEqual(obj);
  });
  ...
  test('Test E.6', () => {
    ...
    const tmp = objectBuilder('user.company.addresses[0].telephones[0].numbers[0].1', {}, 123);
    const result = objectBuilder('user.company.addresses[1].telephones[0].numbers[0].1', tmp, 345);
    expect(result).toStrictEqual(obj);
  });
  ...
  test('Test E.7', () => {
    ...
    let tmp = objectBuilder('user.company.addresses[0].address', {}, 'address1');
...
describe('Object Builder, Arrays and Objects with multiple elements', () => {
  ...
  test('Test F.2', () => {
    ...
    tmp = objectBuilder('user.company.addresses[0].telephones[0].number', tmp, '6955546039');
    const result = objectBuilder('user.company.addresses[0].telephones[1].number', tmp, '2892045475');
  ...
  test('Test F.3', () => {
    ...
    tmp = objectBuilder('order.recipient.addresses[0].address', tmp, 'Leykosia');
    ...
    tmp = objectBuilder('order.recipient.addresses[0].telephones[0].number', tmp, '6903456934');
    tmp = objectBuilder('order.recipient.addresses[0].telephones[1].number', tmp, '2828282828');
